...
def getAOUT(df):
    ...
    alarm_types = [{'fault' : "Alarm", 'sev' : "501"}, 
                   ...
                   {'fault' : "Feedback out of Range", 'sev' : "501"}
                   ]
    ...
    tree.write('export/rockwell/alarms/RA_Alarms_AOUT.xml', pretty_print=True, encoding="utf-8", xml_declaration=True)