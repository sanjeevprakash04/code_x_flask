...
def getVLV(df):
    ...
    alarm_types = [{'fault' : "Alarm", 'sev' : "501"}, 
                   ...
                   {'fault' : "Valve Positive Feedback Alarm", 'sev' : "501"},
                   {'fault' : "Valve Negative Feedback Alarm", 'sev' : "501"}
                   ]
    ...
    tree.write('export/rockwell/alarms/RA_Alarms_VLV.xml', pretty_print=True, encoding="utf-8", xml_declaration=True)