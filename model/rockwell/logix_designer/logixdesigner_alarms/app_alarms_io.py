...
# ---Create alarms for tags with ALM id in the IO list---
...
def getIO(df):
    ...
    tree.write('export/rockwell/alarms/RA_Alarms_ALM.xml', pretty_print=True, encoding="utf-8", xml_declaration=True)