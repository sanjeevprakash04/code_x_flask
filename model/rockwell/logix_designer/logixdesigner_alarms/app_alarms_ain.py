...
# ---Create alarms for tags with AIN id in the IO list---
...
def getAIN(df):
    ...
    alarm_types = [{'fault' : "Alarm", 'sev' : "501"}, 
                   ...
                   {'fault' : "Low Alarm", 'sev' : "251"},
                   {'fault' : "High Warning", 'sev' : "251"},
                   {'fault' : "High-High Alarm", 'sev' : "501"},
                   {'fault' : "Overflow Alarm/Overload", 'sev' : "501"},
                   {'fault' : "Underflow Alarm/Wirebreak", 'sev' : "501"}
                   ]
    ...
    tree.write('export/rockwell/alarms/RA_Alarms_AIN.xml' , pretty_print=True, encoding="utf-8", xml_declaration=True)